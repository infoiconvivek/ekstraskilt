                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <div class="live-preview">
                                ...
                                <form method="post" action="{{url('admin/design-category/save')}}" enctype="multipart/form-data">
                                    @csrf
                                    <div class="row gy-4">
                                        ...
                                        <div class="col-xxl-4 col-md-4">
                                            <div>
                                                ...
                                                <select name="type" class="form-control">
                                                    <option value="" @if(isset($category) && $category->type == '') {{"selected"}} @endif>--Select--</option>
                                                    <option value="1" @if(isset($category) && $category->type == 1) {{"selected"}} @endif>Image</option>
                                                    <option value="2" @if(isset($category) && $category->type == 2) {{"selected"}} @endif>Background</option>
                                                </select>
