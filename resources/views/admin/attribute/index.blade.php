                    ...
                    <div class="card">
                        <div class="card-header align-items-center d-flex">
                            ...
                            <div class="flex-shrink-0">
                                <a href="{{url('admin/attribute/create')}}" class="btn btn-info">Add Attribute</a>
                            </div>
                        </div><!-- end card header -->
                                    ...
                                    <table class="table align-middle table-nowrap mb-0">
                                        ...
                                        <tbody>
                                            ...
                                            <tr row_id="{{$row->id}}" class="get_row_{{$row->id}}">
                                                ...
                                                <td>
                                                    <a class="btn btn-info btn-sm waves-effect waves-light" href="{{url('admin/attribute/edit/'.$row->id)}}">
